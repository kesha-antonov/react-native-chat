...
import type { IMessage, User } from '@kesha-antonov/react-native-chat'
...
function ChatExample() {
  ...
  const onSend = useCallback(
    (newMessages: IMessage[] = []) => {
      ...
      setMessages(previousMessages => Chat.append(previousMessages, messagesWithIds))
    },
    [user]
  )
  ...
  const onPressLoadEarlierMessages = useCallback(() => {
    ...
    setTimeout(() => {
      setMessages(previousMessages => Chat.prepend(previousMessages, getEarlierMessages()))
